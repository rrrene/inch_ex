...
defmodule InchEx do
  defmodule Config do
    defstruct output: "docs",
              source_root: nil,
              source_url: nil,
              source_url_pattern: nil,
              homepage_url: nil,
              source_beam: nil,
              retriever: InchEx.Docs.Retriever,
              formatter: InchEx.Docs.Formatter,
              project: nil,
              version: nil,
              main: nil,
              readme: false,
  ...
  @doc false
  def generate_docs(project, version, args, options)
    ...
    IO.inspect(docs |> InchEx.Docs.Formatter.all_objects(), pretty: true)
  ...
  defp normalize_options(options) do
    pattern =
      options[:source_url_pattern] ||
        guess_url(options[:source_url], options[:source_ref] || "master")
